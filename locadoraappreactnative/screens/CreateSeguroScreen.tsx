...
type Props = DrawerScreenProps<DrawerParamList, 'CreateSeguro'>;

const CreateSeguroScreen = ({ navigation }: Props) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Novo seguro</Text>
