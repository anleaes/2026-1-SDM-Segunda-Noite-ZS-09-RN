...
type Props = DrawerScreenProps<DrawerParamList, 'CreateAdicional'>;

const CreateAdicionalScreen = ({ navigation }: Props) => {
  ...
  const handleSave = async () => {
    setSaving(true);
    await fetch(`${API_URL}/adicionais/`, {
      method: 'POST',
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Novo adicional</Text>
...
export default CreateAdicionalScreen;
